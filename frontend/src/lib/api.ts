...
export const fetchMaterialBySlug = (slug: string) => api.get(`/api/materials/${slug}`)
export const fetchBlogPosts    = () => api.get('/api/blog')
export const fetchBlogPost     = (slug: string) => api.get(`/api/blog/${slug}`)
export const fetchFAQs         = () => api.get('/api/admin/faqs')
