    ...
    <section className="py-16 bg-[#020617]">
      <div className="max-w-3xl mx-auto px-6">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400">Everything you need to know about our metal trading services</p>
        </div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    size={18}
                    className={`flex-shrink-0 ml-4 text-amber-400 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}
                  />
                </button>
                <div
