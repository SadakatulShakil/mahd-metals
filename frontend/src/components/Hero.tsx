      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-32 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
          <a href="https://wa.me/966057296781"
            ...
            {t('hero.whatsapp')} <ArrowRight size={18} className="group-hover:translate-x-1 rtl:group-hover:-translate-x-1 rtl:rotate-180 transition-transform" />
          </a>
          <Link to="/materials"
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 text-gray-200">
          {[
            { icon: ShieldCheck, text: t('hero.years') },
            { icon: Globe,       text: t('hero.countries') },
            { icon: Zap,         text: t('hero.logistics') },
          ].map(({ icon: Icon, text }) => (
